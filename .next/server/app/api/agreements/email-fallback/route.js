...
Contact: info@photoboothguys.ca
    `;return o.NextResponse.json({message:"Agreement sharing link generated successfully",recipientEmail:i.recipientEmail,shareableLink:d,shareableContent:m,note:"Email service is not configured. Use the shareable link above to access your agreement."})}catch(e){if(console.error("Error generating shareable link:",e),e instanceof p.G)return o.NextResponse.json({error:"Validation failed",details:e.errors},{status:400});return o.NextResponse.json({error:"Failed to generate shareable link"},{status:500})}}let d=new n.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/agreements/email-fallback/route",pathname:"/api/agreements/email-fallback",filename:"route",bundlePath:"app/api/agreements/email-fallback/route"},resolvedPagePath:"C:\\Users\\denni\\agreements\\app\\api\\agreements\\email-fallback\\route.ts",nextConfigOutput:"",userland:a}),{workAsyncStorage:m,workUnitAsyncStorage:h,serverHooks:v}=d;function k(){return(0,s.patchFetch)({workAsyncStorage:m,workUnitAsyncStorage:h})}},96487:()=>{},78335:()=>{},71618:(e,t,r)=>{"use strict";r.d(t,{z:()=>n});let a=require("@prisma/client"),n=global.prisma||new a.PrismaClient({log:["error","warn"]})}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),a=t.X(0,[638,452,727],()=>r(82836));module.exports=a})();