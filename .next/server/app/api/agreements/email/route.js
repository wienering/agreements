(()=>{var e={};e.id=712,e.ids=[712],e.modules={10846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},44870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},29294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},63033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},79646:e=>{"use strict";e.exports=require("child_process")},55511:e=>{"use strict";e.exports=require("crypto")},14985:e=>{"use strict";e.exports=require("dns")},94735:e=>{"use strict";e.exports=require("events")},29021:e=>{"use strict";e.exports=require("fs")},81630:e=>{"use strict";e.exports=require("http")},55591:e=>{"use strict";e.exports=require("https")},91645:e=>{"use strict";e.exports=require("net")},21820:e=>{"use strict";e.exports=require("os")},33873:e=>{"use strict";e.exports=require("path")},27910:e=>{"use strict";e.exports=require("stream")},34631:e=>{"use strict";e.exports=require("tls")},79551:e=>{"use strict";e.exports=require("url")},28354:e=>{"use strict";e.exports=require("util")},74075:e=>{"use strict";e.exports=require("zlib")},88681:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>v,routeModule:()=>m,serverHooks:()=>f,workAsyncStorage:()=>x,workUnitAsyncStorage:()=>h});var s={};r.r(s),r.d(s,{POST:()=>g});var n=r(42706),i=r(28203),a=r(45994),o=r(39187),l=r(71618),p=r(98721),c=r(27727),u=r(65665);let d=c.Ik({token:c.Yj().min(1,"Token is required"),recipientEmail:c.Yj().email("Valid email is required")});async function g(e){try{var t,r,s;let n=await e.json(),i=d.parse(n),a=await l.z.agreement.findFirst({where:{uniqueToken:i.token,status:"SIGNED"},include:{client:!0,template:!0}});if(!a)return o.NextResponse.json({error:"Signed agreement not found or has expired"},{status:404});let c=(t=a.template.htmlContent,r=a.client,s=a.id,t.replace(/\{\{client\.firstName\}\}/g,r.firstName||"").replace(/\{\{client\.lastName\}\}/g,r.lastName||"").replace(/\{\{client\.email\}\}/g,r.email||"").replace(/\{\{client\.phone\}\}/g,r.phone||"").replace(/\{\{client\.eventDate\}\}/g,r.eventDate?new Date(r.eventDate).toLocaleDateString():"").replace(/\{\{client\.notes\}\}/g,r.notes||"").replace(/\{\{event\.type\}\}/g,r.eventType||"").replace(/\{\{event\.location\}\}/g,r.eventLocation||"").replace(/\{\{event\.startTime\}\}/g,r.eventStartTime||"").replace(/\{\{event\.duration\}\}/g,r.eventDuration||"").replace(/\{\{event\.package\}\}/g,r.eventPackage||"").replace(/\{\{agreement\.date\}\}/g,new Date().toLocaleDateString()).replace(/\{\{agreement\.id\}\}/g,s||""));if(!process.env.SMTP_HOST||!process.env.SMTP_USER||!process.env.SMTP_PASS)return o.NextResponse.json({error:"Email service is not configured. Please contact support to set up email functionality."},{status:503});let u=p.createTransport({host:process.env.SMTP_HOST,port:parseInt(process.env.SMTP_PORT||"587"),secure:"465"===process.env.SMTP_PORT,auth:{user:process.env.SMTP_USER,pass:process.env.SMTP_PASS},connectionTimeout:1e4,greetingTimeout:1e4,socketTimeout:1e4}),g=`
          ...
          <div class="email-container">
            ...
            <div class="content">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${process.env.NEXT_PUBLIC_BASE_URL||"http://localhost:3000"}/agreement/${i.token}" class="button">View Online</a>
    ...
    `,m={from:process.env.SMTP_FROM||process.env.SMTP_USER,to:i.recipientEmail,subject:`Signed Agreement - ${a.client.firstName} ${a.client.lastName}`,html:g};try{await u.verify();let e=await Promise.race([u.sendMail(m),new Promise((e,t)=>setTimeout(()=>t(Error("Email send timeout")),15e3))]);return console.log("Email sent successfully:",e),o.NextResponse.json({message:"Agreement sent successfully",recipientEmail:i.recipientEmail})}catch(e){if(console.error("Email sending failed:",e),e.message&&e.message.includes("timeout"))return o.NextResponse.json({error:"Email service is currently unavailable. Please try again later or contact support."},{status:503});if(e.message&&e.message.includes("authentication"))return o.NextResponse.json({error:"Email authentication failed. Please contact support to fix email configuration."},{status:503});return o.NextResponse.json({error:"Failed to send email. Please try again later or contact support."},{status:500})}}catch(e){if(console.error("Error sending email:",e),e instanceof u.G)return o.NextResponse.json({error:"Validation failed",details:e.errors},{status:400});return o.NextResponse.json({error:"Failed to send email"},{status:500})}}let m=new n.AppRouteRouteModule({definition:{kind:i.RouteKind.APP_ROUTE,page:"/api/agreements/email/route",pathname:"/api/agreements/email",filename:"route",bundlePath:"app/api/agreements/email/route"},resolvedPagePath:"C:\\Users\\denni\\agreements\\app\\api\\agreements\\email\\route.ts",nextConfigOutput:"",userland:s}),{workAsyncStorage:x,workUnitAsyncStorage:h,serverHooks:f}=m;function v(){return(0,a.patchFetch)({workAsyncStorage:x,workUnitAsyncStorage:h})}},96487:()=>{},78335:()=>{},71618:(e,t,r)=>{"use strict";r.d(t,{z:()=>n});let s=require("@prisma/client"),n=global.prisma||new s.PrismaClient({log:["error","warn"]})}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),s=t.X(0,[638,452,727,721],()=>r(88681));module.exports=s})();