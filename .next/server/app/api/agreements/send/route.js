      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <div class="urgent">
              <strong>⏰ Important:</strong> This agreement expires on ${a.expiresAt?new Date(a.expiresAt).toLocaleDateString():"the specified date"}. Please review and sign before the expiration date.
            </div>
